...
The compose file will pull and run ghost ,nginx and mysql containers. Additionally, it will also persist the data generated by the containters by using volume.
